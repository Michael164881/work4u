...
@section('content')
    ...
    <div class="content">
        <div class="form-container">
            ...
            <form action="{{ route('jobRequest.update', $jobRequest->id) }}" method="POST">
                @csrf
                <div class="form-group">
                    <label for="job_name">Job Name</label>
                    <input type="text" id="job_name" name="job_name" value="{{ $jobRequest->job_name }}" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="job_period" name="job_period" value="{{ $jobRequest->job_period }}" required>
                </div>
                <div class="form-group">
