                                                ...
                                                <p class="notification-info">
                                                    @switch($notification->notification_info)
                                                        ...
                                                        @case('work description updated')
                                                            ...
                                                            <p>The work description (ID: {{ $notification->workDescription->work_description_name }}) has been updated.</p>
                                                            @break

                                                        @case('work description created')
                                                            <h2><STRONG>WORK DESCRIPTION CREATED</STRONG></h2><br>
                                                            <p>A new work description (ID: {{ $notification->workDescription->work_description_name }}) has been created.</p>
                                                            @break
